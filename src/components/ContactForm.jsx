...
import { PhoneIcon, EnvelopeIcon, MapPinIcon, ChatBubbleBottomCenterTextIcon } from '@heroicons/react/24/outline'
...
const ContactForm = () => {
  ...
  return (
    ...
    >
      <div className=" mb-8">
        <motion.h2 variants={itemVariants} className="text-lg font-bold text-gray-800 mt-16">
          Contact
        </motion.h2>
        <motion.p variants={itemVariants} className="text-5xl text-black mt-2 font-bold">
...
<div className="flex items-center gap-2">
  ...
  <span>Burewala Pakistan</span>
        ...
        <motion.div variants={itemVariants}>
          <motion.h3 variants={itemVariants} className="text-3xl font-semibold text-black mt-16 mb-6">
            Send A Message
          </motion.h3>
  ...
  <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2  gap-4">
    <div className="md:min-w-[300px]"> 
      <label htmlFor="" className="text-black block mb-1 lg:ml-[-150px]">Name</label>
      <input 
        type="text" 
        placeholder="Name" 
    ...
    <div className="md:min-w-[300px]">
      <label htmlFor="" className="text-black block mb-1">Phone</label>
      <input 
        type="text" 
        placeholder="Phone" 
  ...
  <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div className="md:min-w-[300px]">
      <label htmlFor="" className="text-black block mb-1 lg:ml-[-150px]">Email</label>
      <input 
        type="email" 
        placeholder="Email" 
        className=" bg-[#E2E2E2] w-full lg:min-w-[350px] px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#FFB600] lg:ml-[-150px]"
    ...
    <div className="md:min-w-[300px]">
      <label htmlFor="" className="text-black block mb-1">Subject</label>
      <input 
        type="text" 
        placeholder="Subject" 
        className=" bg-[#E2E2E2]  w-full lg:min-w-[350px] px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#FFB600]"
  ...
  <motion.div variants={itemVariants}>
    <label htmlFor="" className="text-black block mb-1 lg:ml-[-150px]">Message</label>
    <textarea 
      placeholder="Message" 
      rows="4"
