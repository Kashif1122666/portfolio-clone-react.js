...
<h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-black mb-2 lg:text-6xl">
  I help you build <span className='text-[#FFB600]'>brand</span> for your <br /> business
</h2>
</div>
<div className='flex gap-9 mt-8 flex-wrap'>
    <button className='bg-[#FFB600] text-black px-3 py-2 rounded ' >RECENT WORK</button>
    {works.map((work, index) => (
        <span key={index} className='text-black hover:text-[#FFB600] cursor-pointer text-xl'>{work.text}</span>
    ))}
</div>
