      ...
      <div>
        ...
        <div className="w-full px-0 mx-0">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-black mb-2 lg:text-6xl">
            Check Out the <span className="text-[#FFB600]">Course</span>{" "}
            Introduction
          </h2>
        </div>
        ...
        <div className="flex justify-center items-center mt-4">
          <button className="bg-[#FFB600] hover:bg-[#000000] hover:text-white transition duration-75 text-black px-20 py-4 rounded font-bold">
