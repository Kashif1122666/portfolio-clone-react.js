...
function OurClients() {
  ...
  return (
    <section id="services" className="bg-[#F2F2F2] py-16 px-4 sm:px-10 lg:px-20 ">
      ...
      <div className="w-full px-5 mx-0 ">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-black mb-2 lg:text-6xl">
          See what my <span className='text-[#FFB600]'>happy clients</span> say <br /> about me   
        </h2>
      </div>
...
>
            ...
            <SwiperSlide key={index}>
              <div className="flex flex-col gap-6 ">
                ...
                <div className="relative bg-[#797979] text-white py-1 px-6 rounded-xl w-full md:w-3/4 text-lg font-light leading-relaxed shadow-md">
                  <div className="text-yellow-400 text-7xl mb-2 font-serif ">“</div>
                  <span className='text-2xl'>{item.text}</span>
                  <div className="text-yellow-400 text-7xl mt-9 font-serif">”</div>
               ...
               <img src={item.image} alt={item.name} className="w-32 h-32 rounded-full   shadow-lg object-cover" />
                <div>
     ...
     <button onClick={handlePrev} className='bg-[#FFB600] text-white px-3 rounded text-6xl hover:bg-black hover:text-white hover:border hover:border-yellow-400'>	&lt;</button>
     <button onClick={handleNext} className='bg-[#FFB600] text-white px-3 rounded text-6xl hover:bg-black hover:text-white hover:border hover:border-yellow-400'>	&gt;</button>
      </div>
